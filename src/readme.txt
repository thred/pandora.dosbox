...
This is based on the "WinBox" by urjaman, but it changes the startup behavior.

It asks you for the directory, that should act as C drive, everytime it starts.
It places a dosbox.conf file within this directory (if none exists) and uses it.
That's how you are able to configure the DOSBox for this specific application.
...
again. R2: The mouse code has been changed a bit (FYI).
Normal dosbox readme follows:
